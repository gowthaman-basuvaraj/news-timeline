...
class Controller_news extends Controller_Base {
  ...
  public function action_add($section_name=null,$story_urltitle=NULL) {
    ...
    if (Request::$method == "POST") {
      ...
      try {
        ...
        $values["username"] = $this->logged_user->username;
        ...
        $news->update();
        if ($original_story != NULL) {
          $original_story->followups_count->increment();
  ...
  public function action_comment_delete($story_urltitle, $original_comment_title) {
    ...
    if ($comment->loaded()) {
      ...
      //TODO reduce comment count from story
      die("OK");
    }
    die("OK NOT");
  }
  ...
  public function action_comment($story_urltitle, $original_comment_title=NULL) {
    ...
    if (Request::$method == "POST") {
      ...
      try {
        ...
        if ($original_story != NULL) {
          $original_story->comments_count->increment();
          $original_story->update();
